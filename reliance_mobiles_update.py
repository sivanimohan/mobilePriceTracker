...
def fetch_urls():
    db_cursor.execute("SELECT redirect_link FROM Mobiles WHERE platform_name = 'Reliance Digitals'")
    ...
    try:
        ...
        if result:
            ...
            if old_price != new_price:
                db_cursor.execute("UPDATE Mobiles SET price = %s WHERE redirect_link = %s",
